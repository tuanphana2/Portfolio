...
const skillsList = [
  { id: 1, skill: 'Figma', percentage: '90%', image: figma },
  { id: 2, skill: 'Wordpress', percentage: '95%', image: word },
  { id: 3, skill: 'HTML', percentage: '85%', image: html },
  { id: 4, skill: 'Bootstrap', percentage: '97%', image: boot },
];
