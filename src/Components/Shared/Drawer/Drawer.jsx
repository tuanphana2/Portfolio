  ...
  return (
    <div className={`subside__barmenu ${isSidebarActive ? 'active' : ''}`}>
      <button
        ...
        className="remove__click d-flex justify-content-cent  er align-items-center"
      >
        <i>
          <XLg />
        </i>
      ...
      <div className="sub__contact__wrapper d-grid">
        ...
        <p>
          Neque porro quisquam est, qui dolorem ipsum quia dolor sit consectetur, aliquam quaerats
          voluptatem. Ut enim ad minima veniam, exercitationem laboriosam, nisi ut aliquid ex ea
          autem velit esse quam nihil
        </p>
