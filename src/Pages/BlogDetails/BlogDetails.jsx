                  ...
                  <div className="content__two">
                    <div className="text__box mb-30" data-aos="fade-up" data-aos-duration="1400">
                      ...
                      <p className="fz-16 pra ttext__one">
                        ...
                        to use a Lorem Ipsum, you need to be sure there isn't anything embarrassing
                        hidden in the middle of text. All the Lorem Ipsum the Internet tend to
                        repeat predefined chunks as necessary,
                      </p>
                      <p className="fz-16 pra">
                        Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit,
                        sed quia consequuntur magni neque porro quisquam est, qui dolorem ipsum quia
                        dolor sit amet, adipisci velit, sed quia non numquam eius modi tempora
                        incidunts ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad
                        minima veniam, quis nostrum exercitationem the corporis suscipit laboriosam,
                        nisi ut aliquid
                      </p>
                    </div>
                    <div className="quite__box mb-30">
                      ...
                      <p>
                        ...
                        nesciunt. Neque porro quisquam est, adipisci velit, sed quia non numquam
                      </p>
                    ...
                    <p className="fz-16 pra ttext__one mb__cus60">
                      ...
                      dolore magnam aliquam minima veniam, quis nostrum exercitationem ullam
                      corporis suscipit laboriosam,
                    </p>
                    <h3 className="white mb-30">Matias is the only theme you will ever need</h3>
                    ...
                    <p className="fz-16 pra ttext__one mb-30">
                      ...
                      through weakness of will, which is the same as from these cases are perfectly
